...
<head>
    ...
    <link rel="shortcut icon" href="${ctx}/static/back/favicon.ico"> <link href="${ctx}/static/back/css/bootstrap.min.css?v=3.3.5" rel="stylesheet">
    ...
    <!-- Gritter -->
    <link href="${ctx}/static/back/js/plugins/gritter/jquery.gritter.css" rel="stylesheet">

    <link href="${ctx}/static/back/css/animate.min.css" rel="stylesheet">
    <link href="${ctx}/static/back/css/style.min.css?v=4.0.0" rel="stylesheet"><base target="_blank">
...
<body class="gray-bg">
                        ...
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <ul class="todo-list m-t small-list ui-sortable">
                                    <li>
                                        <a href="${ctx}/static/back/widgets.html#" class="check-link"><i class="fa fa-check-square"></i> </a>
                                    ...
                                    <li>
                                        <a href="${ctx}/static/back/widgets.html#" class="check-link"><i class="fa fa-square-o"></i> </a>
    ...
    <script src="${ctx}/static/back/js/bootstrap.min.js?v=3.3.5"></script>
    <script src="${ctx}/static/back/js/plugins/flot/jquery.flot.js"></script>
    <script src="${ctx}/static/back/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
    <script src="${ctx}/static/back/js/plugins/flot/jquery.flot.spline.js"></script>
    <script src="${ctx}/static/back/js/plugins/flot/jquery.flot.resize.js"></script>
    <script src="${ctx}/static/back/js/plugins/flot/jquery.flot.pie.js"></script>
    <script src="${ctx}/static/back/js/plugins/flot/jquery.flot.symbol.js"></script>
    <script src="${ctx}/static/back/js/plugins/peity/jquery.peity.min.js"></script>
    <script src="${ctx}/static/back/js/demo/peity-demo.min.js"></script>
    <script src="${ctx}/static/back/js/content.min.js?v=1.0.0"></script>
    <script src="${ctx}/static/back/js/plugins/jquery-ui/jquery-ui.min.js"></script>
    <script src="${ctx}/static/back/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
    <script src="${ctx}/static/back/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
    <script src="${ctx}/static/back/js/plugins/easypiechart/jquery.easypiechart.js"></script>
    <script src="${ctx}/static/back/js/plugins/sparkline/jquery.sparkline.min.js"></script>
    <script src="${ctx}/static/back/js/demo/sparkline-demo.min.js"></script>
    <script>
